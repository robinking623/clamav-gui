    ...
    for (int i = 0; i < keywords.length(); i++) {
        ...
        switch (i) {
            case 0 : if (value.right(1) != ""){
                     ...
                     flag == true?ui->frame01->setStyleSheet(css):ui->frame01->setStyleSheet("");
            ...
            case 1 : if (value.right(1) != ""){
                     ...
                     flag == true?ui->frame02->setStyleSheet(css):ui->frame02->setStyleSheet("");
            ...
            case 2 : ui->maxNumberForContainerCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame03->setStyleSheet(css):ui->frame03->setStyleSheet("");
            ...
            case 3 : ui->maxArchiveRecursionForContainerCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame04->setStyleSheet(css):ui->frame04->setStyleSheet("");
            ...
            case 4 : ui->maxDirRecursionLevelCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame05->setStyleSheet(css):ui->frame05->setStyleSheet("");
            ...
            case 5 : if (value.right(1) != ""){
                     ...
                     flag == true?ui->frame06->setStyleSheet(css):ui->frame06->setStyleSheet("");
            ...
            case 6 : if (value.right(1) != ""){
                     ...
                     flag == true?ui->frame07->setStyleSheet(css):ui->frame07->setStyleSheet("");
            ...
            case 7 : if (value.right(1) != ""){
                     ...
                     flag == true?ui->frame08->setStyleSheet(css):ui->frame08->setStyleSheet("");
            ...
            case 8 : if (value.right(1) != ""){
                     ...
                     flag == true?ui->frame09->setStyleSheet(css):ui->frame09->setStyleSheet("");
            ...
            case 9 : if (value.right(1) != ""){
                     ...
                     flag == true?ui->frame10->setStyleSheet(css):ui->frame10->setStyleSheet("");
            ...
            case 10: ui->maxNumberOfPartitionsInDiskImageCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame11->setStyleSheet(css):ui->frame11->setStyleSheet("");
            ...
            case 11: ui->maxNumberOfIconsInPEFileCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame12->setStyleSheet(css):ui->frame12->setStyleSheet("");
            ...
            case 12: ui->numberOfSecondsToWaitForResponseCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame13->setStyleSheet(css):ui->frame13->setStyleSheet("");
            ...
            case 13: ui->numberOfSecondsToWaitForByteCodeCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame14->setStyleSheet(css):ui->frame14->setStyleSheet("");
            ...
            case 14: ui->collectAndPrintExecutionStatisticsCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame15->setStyleSheet(css):ui->frame15->setStyleSheet("");
            ...
            case 15: ui->structuredSSNFormatCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame16->setStyleSheet(css):ui->frame16->setStyleSheet("");
            ...
            case 16: ui->structuredSSNCountCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame17->setStyleSheet(css):ui->frame17->setStyleSheet("");
            ...
            case 17: ui->structuredCCCountCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame18->setStyleSheet(css):ui->frame18->setStyleSheet("");
            ...
            case 18: ui->structuredCCModeCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame19->setStyleSheet(css):ui->frame19->setStyleSheet("");
            ...
            case 19: ui->maxScanTimeCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame20->setStyleSheet(css):ui->frame20->setStyleSheet("");
            ...
            case 20: ui->maxRecursionHWP3CheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame21->setStyleSheet(css):ui->frame21->setStyleSheet("");
            ...
            case 21: ui->maxPCREMatchCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame22->setStyleSheet(css):ui->frame22->setStyleSheet("");
            ...
            case 22: ui->maxRecursionPCREMatchCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame23->setStyleSheet(css):ui->frame23->setStyleSheet("");
            ...
            case 23: if (value.right(1) != ""){
                     ...
                     flag == true?ui->frame24->setStyleSheet(css):ui->frame24->setStyleSheet("");
            ...
            case 24: ui->databaseOutdatedCheckBox->setChecked(flag);
                     ...
                     flag == true?ui->frame25->setStyleSheet(css):ui->frame25->setStyleSheet("");
